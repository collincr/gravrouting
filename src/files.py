...
tmp_adj_json = '../data/tmp_dij_adj.json'
tmp_dist_json = '../data/tmp_dij_dist.json'
test_graph_adj_csv = '../data/test_graph_adj.csv'
test_graph_edge_csv = '../data/test_graph_edge.csv'
