...
def main():
    ...
    cluster_seq = ['10', '11', '8', '6', '3', '9', '2', '7', '1', '5', '0', '4']
    start = t.time()
    total_times = cr.route_with_sequence(cluster_seq, updated_cluster_dic)
    print("Time spent: " + str(dt.timedelta(seconds = t.time() - start)))
    res = {}
    day = 1
